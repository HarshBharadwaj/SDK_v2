...
public class Search_SiteActions extends Search_Page {
    ...
    {
        await();
        //Assert.assertEquals(awaitForElementPresence(searchBox),"true","Search box is not present");
    ...
    public void testEnterButtonInCaseOfSearch(String query) throws InterruptedException {
        ...
        Thread.sleep(3000);
        Assert.assertEquals(searchResultQuery.getText(),query,"Search using enter button is not working");
    }

    public  void testSearchedResultsMessageFormat() throws InterruptedException {
        searchAction(unbxdSearchQuery);
        Assert.assertTrue(searchResultFormat.getText().contains("Results for -"),"Searched Results Message Format is not correct");
...
//        }
    ...
    public void testInvalidSearchQuery(String invQuery) throws InterruptedException {
        ...
        searchBoxClick.click();
        Thread.sleep(2500);
        Assert.assertEquals(awaitForElementPresence(noResultFound),"true","Zero Result page is not getting displayed");
...
//        }else{System.out.println("Test Case 15: Fail: don't Enter Query Click SearchIcon, but search is working.");}
    ...
    public void dontEnterQueryPressEnterKey() {
        ...
        String newUrl= getDriver().getCurrentUrl();
        Assert.assertEquals(oldURl,newUrl,"Don't Enter Query press Enter key,but search is working");
//        if(oldURl.equals(newUrl)) {
...
//        else{System.out.println("Test Case 7: Fail: Grid View is getting displayed");}
    ...
    public void testListViewClick() throws InterruptedException {
        await();
        searchAction(unbxdSearchQuery);
        listViewClick.click();
        awaitForPageToLoad();
...
//        System.out.println("--------------------------------------------------");
    ...
    public void testGridViewClick() throws InterruptedException {
        await();
        searchAction(unbxdSearchQuery);
        gridViewClick.click();
        Thread.sleep(2000);
...
//        }
    ...
    public void testSpacingBetweenMoreThanTwoWords() throws InterruptedException {
        ...
        searchBoxClick.click();
        Thread.sleep(3000);
        Assert.assertEquals(searchResultQuery.getText(),threeWordQuery,"Spacing between more than three word is not working as expecting on SRP");
...
//        }
    ...
    public void testSpacingBetweenTwoWords() throws InterruptedException {
        ...
        Thread.sleep(3000);
        Assert.assertTrue(searchResultQuery.getText().equals(twoWordQuery),"Spacing between two word is not working as expecting on SRP");
...
//        Thread.sleep(2500);
        ...
        Assert.assertEquals(uniqueIDPath.getAttribute("data-uniqueid"),uniqueId,"Search using uniqueId is not working.");
...
//        Thread.sleep(3000);
        ...
        Assert.assertTrue(searchResultQuery.getText().equals(lowerCaseQuery),"Search using lower case query is not working as expected");
...
//        Thread.sleep(3000);
        ...
        Assert.assertEquals(awaitForElementPresence(didYouMean),"true","Spell error message (did you mean) is not getting displayed");
    ...
    public void testDidYouMeanLinkIsWorkingOrNot() throws InterruptedException {
        ...
        Thread.sleep(2000);
        Assert.assertEquals(searchResultQuery.getText(),threeWordQuery,"Did you mean click is not working");
    ...
    public void testWhetherTwoWordsSpellErrorIsWorking() throws InterruptedException {
        ...
        searchBoxClick.click();
        Thread.sleep(3000);
        Assert.assertEquals(spellCorrectWord.getText(),twoWordQuery,"Two word spell check error is not working.");
    ...
    public void testWhetherThreeWordsSpellErrorIsWorking() throws InterruptedException {
        ...
        searchBoxClick.click();
        Thread.sleep(2000);
        Assert.assertEquals(spellCorrectWord.getText(),threeWordQuery,"Three word spell check error is not working.");
...
//        System.out.println("----------------------------------------------------");
    ...
    private void checkUnbxdAttribute() throws InterruptedException {
        searchAction(lowerCaseQuery);
        Assert.assertTrue(searchResultQuery.isDisplayed(),"Search result query is not getting displayed.");
...
//        else{System.out.println("Fail: Search result query is not getting displayed on SRP.");}
        Assert.assertTrue(productDescription.isDisplayed(),"Search result description is not getting displayed");
...
//        else{System.out.println("Fail: List view is not getting displayed on SRP.");}
        Assert.assertTrue(listViewClick.isDisplayed(),"List view is not getting displayed.");
        ...
        Assert.assertTrue(gridViewClick.isDisplayed(),"Grid view is not getting displayed.");
        ...
        Assert.assertTrue(paginationDisplayOrNot.isDisplayed(),"Pagination is not getting displayed");
        ...
        Assert.assertTrue(pageSizeContainer.isDisplayed(),"Page size dropdown is not getting displayed");
        ...
        Assert.assertTrue(sortByContainer.isDisplayed(),"Sort By dropdown is not getting displayed.");
        ...
        Assert.assertTrue(facetContainer.isDisplayed(),"Facet container is not getting displayed");
        ...
        Assert.assertTrue(productContainer.isDisplayed(),"Product list is not getting displayed");
    }
    ...
    public void testInCaseOfTwoPrices() throws InterruptedException {
        ...
        List<WebElement> allProductPrice=getDriver().findElements(By.xpath(UnbxdProductPrice));
        Assert.assertEquals(allProductPrice.size(),allProductStrickenPrice.size(),"For all product stricken price is not present");
    ...
    public void  checkTotalNumberOfProductsInSearchedResultsPageAndAPI() throws InterruptedException {
        ...
        String totalProductUI=totalSrcResult[1].replace("products","").replace(" ","");
        Assert.assertEquals(totalProductUI,productCount,"Fail: Total number Of products in searched results page and API is not same");
...
//        }else{
//            System.out.println("Fail: Total number Of products in searched results page and API is not same");
//        }
